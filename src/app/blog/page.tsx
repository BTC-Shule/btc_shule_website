      ...
      <main className="pt-[72px] md:pt-[136px] bg-gradient-to-b from-background to-gray-50">
        ...
        <section className="relative py-20">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            >
              Explore our latest articles, thought leadership pieces, and
              Bitcoin adoption stories from around the world.
            </motion.p>
            <div className="mt-6 mx-auto w-28 h-1 bg-secondary-light rounded-full"></div>
          </div>
        </section>
